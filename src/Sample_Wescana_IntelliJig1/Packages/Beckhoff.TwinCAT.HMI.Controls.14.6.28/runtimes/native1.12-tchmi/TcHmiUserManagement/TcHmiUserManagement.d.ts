...
declare class TcHmiUserManagement extends TcHmi.Controls.System.TcHmiControl {
    ...
    /**text font size unit */
    protected __userNameFontSizeUnit: FontSizeUnit | undefined;
    /**headline font size */
    protected __headlineFontSize: number | undefined;
    /**headline font size unit */
    protected __headlineFontSizeUnit: FontSizeUnit | undefined;
    /**sub headline font size */
    protected __subHeadlineFontSize: number | undefined;
    /** subheadline font size unit */
    protected __subHeadlineFontSizeUnit: FontSizeUnit | undefined;
    /** drop down font size */
     ...
     */
    setUserNameFontSizeUnit(valueNew: FontSizeUnit | null): void;
    /**
...
export declare class EditUserPopup extends UserManagementPopup {
    ...
    protected __apiAccessResult: Server.UserManagement.IApiAccessResultObject | undefined;
    /** Advanced mode flag */
    protected __advanced: boolean;
    /**
...
export declare class ManageUserPopup extends UserManagementPopup {
    ...
    /** List of user groups */
    protected __groupList: Dictionary<Server.UserManagement.IGroupDetails> | undefined;
    /**content buttons*/
...
export declare class ChangeUserPopup extends UserManagementPopup {
    ...
    protected __groupCheckboxes: Map<string, TcHmiCheckbox>;
    /**List of all users*/
    protected __userList: Dictionary<Server.UserManagement.IUserDetails>;
    /**user details of the selected user*/
    protected __selectedUserDetails: Server.UserManagement.IUserDetails | undefined;
    /**name of the selected user*/
    protected __selectedUserName: string | null | undefined;
