...
export declare class RecipeReferenceEditor {
    ...
    protected __versionCombobox: TcHmiCombobox<VersionComboboxData, ListItemGeneric<VersionComboboxData>[]> | null;
    protected __versioning: {
        use: Promise<boolean>;
    ...
    /**
     * Handler for the onSelectionChanged event of the version combobox.
     */
    ...
    /**
     * Sets the internal __versioning.selectedRecipe variable, updates the comboboxes srcData and selects the latest or
     * given recipe version.
     * @param versionedRecipe The new recipe.
     * @param version The version to select. If not specified, the latest version will be selected.
     */
    protected __setVersionedRecipe(versionedRecipe: {
        name: string;
        recipe: Dictionary<Server.RecipeManagement.Recipe>;
    } | null, version?: string): void;
    /**
     * Callback for received recipe lists.
     * @param rootDirectory The recipe list.
     */
    protected __onRecipeListReceived(rootDirectory: Server.RecipeManagement.FolderRecipe | null, versioningPromise: Promise<boolean>): Promise<void>;
    /**
     * Sets localizable texts to the given localization symbols.
     * @param texts A collection of localization symbol expressions.
     */
...
export declare class CreateRecipePrompt extends OkCancelPrompt<{
     ...
     */
    constructor(parentControl: TcHmiControl.Control);
    /**
...
export declare class FileConflictPrompt extends OkCancelPrompt<Map<string, string>> {
     ...
     * @param parentControl The control which owns the popup.
     */
    constructor(conflictingNames: Map<string, boolean>, existingNames: Iterable<string>, parentControl: TcHmiControl.Control);
    /**
     * Destroys the popup and all its controls.
     * @param force If true, child controls will be removed from the parent control before destruction, to ensure destruction in case of keepAlive === true.
     */
