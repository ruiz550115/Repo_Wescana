import { Controls, EventProvider, type Locale, ObjectResolver, Server, TcHmiControl, TcHmiRegion, type Filter, type FontFamily, type FontSizeUnit, type FontStyle, type FontWeight, type SolidColor, type SortingInfo, type IFunction } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
declare class TcHmiEventLine extends TcHmiControl.Control {
    ...
    protected __sorting: SortingInfo[] | undefined | null;
    /**Eventlist */
    protected __event: Server.Events.Message | Server.Events.Alarm | Server.Events.PayloadEvent | undefined;
     ...
     */
    protected __onResolverForMessageFormatWatchCallback(data: ObjectResolver.IWatchResultObject<MessageFormat>): void;
    /**
     ...
     */
    protected __onResolverForSortingWatchCallback(data: ObjectResolver.IWatchResultObject<SortingInfo[] | null>): void;
    /**
     * Returns the current value of the member variable sorting.
     */
    getSorting(): SortingInfo[] | null | undefined;
    /**
