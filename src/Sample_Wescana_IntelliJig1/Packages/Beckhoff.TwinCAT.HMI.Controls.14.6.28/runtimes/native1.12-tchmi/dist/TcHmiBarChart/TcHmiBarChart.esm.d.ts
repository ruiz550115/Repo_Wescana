import { Controls, EventProvider, FilterInstance, LocalStorage, ObjectResolver, TcHmiControl, type Color, type Filter, type FontFamily, type FontSizeUnit, type FontStyle, type FontWeight, type HorizontalAlignment, type SolidColor, type VerticalAlignment, type IFunction } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
import { BarChart } from '../TcHmiCharting/BarChart.js';
import { AxisLabeling, AxisPosition, Orientation } from '../TcHmiCharting/Types.js';
...
declare class TcHmiBarChart extends TcHmiControl.Control {
    ...
    /** BarChart element */
    protected __barChart: BarChart | null;
    ...
    protected __yAxisLabeling: keyof typeof AxisLabeling | undefined;
    ...
    protected __yLabelFontColor: SolidColor | null | undefined;
    /** Internal reference to the attribute 'data-tchmi-y-axis-width' */
    ...
    protected __yAxisNameFontColor: SolidColor | null | undefined;
    ...
    protected __yAxisFormat: IFunction.IFunction<string> | null | undefined;
    ...
    protected __barGraphColors: SolidColor[] | SolidColor | null | undefined;
    /** __barGraphColors as an array of TcHmi.SolidColor or null */
    protected __barGraphColorArray: SolidColor[] | null | undefined;
     ...
     */
    protected __rebuild(_event: EventProvider.Event, _control: TcHmiControl.Control): void;
    /**
     ...
     */
    protected __onResolverForBarGraphDescriptionsWatchCallback(data: ObjectResolver.IWatchResultObject<BarGraphDescription[]>): void;
    /**
     ...
     */
    protected __onResolverForBarGraphColorsWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor | SolidColor[]>): void;
    /**
     ...
     */
    protected __onResolverForBarGraphDataWatchCallback(data: ObjectResolver.IWatchResultObject<number[] | number[][]>): void;
    /**
     ...
     */
    setYAxisLabeling(valueNew: keyof typeof AxisLabeling | null): void;
    /**
     ...
     */
    protected __onResolverForYLabelFontColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    /**
     ...
     */
    protected __onResolverForYAxisNameFontColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    /**
     ...
     */
    setYAxisFormat(valueNew: IFunction.IFunction<string> | null): void;
    /**
     * The watch callback for the yAxisFormat object resolver.
     */
    protected __onResolverForYAxisFormatWatchCallback(data: ObjectResolver.IWatchResultObject<IFunction.IFunction<string>>): void;
    /**
     * Gets the current yAxisFormat method.
     * @returns the current yAxisFormat method.
     */
    getYAxisFormat(): IFunction.IFunction<string> | null | undefined;
    /**
     * Processes the current xAxisFormat method
     */
