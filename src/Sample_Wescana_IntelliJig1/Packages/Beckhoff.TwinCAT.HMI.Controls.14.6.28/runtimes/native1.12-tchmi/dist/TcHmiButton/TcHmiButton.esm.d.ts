import { Controls, EventProvider, ObjectResolver, Symbol, TcHmiControl, type Background, type DestroyFunction, type DimensionUnit, type FontFamily, type FontSizeUnit, type FontStyle, type FontWeight, type FourSidedCss, type HorizontalAlignment, type SizeModeWithContent, type SolidColor, type VerticalAlignment } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
declare class TcHmiButton extends TcHmiControl.Control {
     ...
     */
    protected __icon: Partial<Background>;
    /**
     ...
     */
    protected __onResolverForIconPaddingWatchCallback(data: ObjectResolver.IWatchResultObject<FourSidedCss | null>): void;
    /**
     ...
     */
    setIconVerticalAlignment(valueNew: VerticalAlignment | null): void;
    /**
