import { Controls, EventProvider, type Locale, ObjectResolver, TcHmiControl, type Color, type FontFamily, type FontSizeUnit, type FontStyle, type FontWeight, type SolidColor, type IFunction } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
...
declare class TcHmiRadialGauge extends TcHmiControl.Control {
    ...
    protected __valueFormat: IFunction.IFunction<string> | null | undefined;
    ...
    protected __labelFormat: IFunction.IFunction<string> | null | undefined;
    /**
     ...
     */
    protected __unitColor: SolidColor | null | undefined;
    /**
     ...
     */
    protected __onResized(_event: EventProvider.Event, _ctrl: TcHmiControl.Control): void;
     ...
     */
    setValueFormat(valueNew: IFunction.IFunction<string> | null): void;
    /**
     * The watch callback for the valueFormat object resolver.
     */
    protected __onResolverForValueFormatWatchCallback(data: ObjectResolver.IWatchResultObject<IFunction.IFunction<string>>): void;
    /**
     * Gets the current valueFormat method.
     * @returns the current valueFormat method.
     */
    getValueFormat(): IFunction.IFunction<string> | null | undefined;
    /**
     ...
     */
    protected __onResolverForRangeWatchCallback(data: ObjectResolver.IWatchResultObject<Range[]>): void;
    /**
     ...
     */
    protected __onResolverForTickDefinitionWatchCallback(data: ObjectResolver.IWatchResultObject<TickDefinition>): void;
    /**
     ...
     */
    setLabelFormat(valueNew: IFunction.IFunction<string> | null): void;
    /**
     * The watch callback for the labelFormat object resolver.
     */
    protected __onResolverForLabelFormatWatchCallback(data: ObjectResolver.IWatchResultObject<IFunction.IFunction<string>>): void;
    /**
     * Gets the current labelFormat method.
     * @returns the current labelFormat method.
     */
    getLabelFormat(): IFunction.IFunction<string> | null | undefined;
    /**
     ...
     */
    protected __onResolverForUnitColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    /**
     ...
     */
    protected __onResolverForTickColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    /**
     ...
     */
    protected __onResolverForGaugeBackgroundColorWatchCallback(data: ObjectResolver.IWatchResultObject<Color>): void;
    /**
     ...
     */
    protected __onResolverForProgressForegroundColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    /**
     ...
     */
    protected __onResolverForProgressBackgroundColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    /**
     ...
     */
    protected __onResolverForKnobColorWatchCallback(data: ObjectResolver.IWatchResultObject<Color | null>): void;
    /**
     ...
     */
    protected __onResolverForKnobArrowsColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    /**
     * Returns the current value of KnobColor.
     */
     ...
     */
    protected __onResolverForSetPointMarkerColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    /**
     ...
     */
    protected __onResolverForMarkersWatchCallback(data: ObjectResolver.IWatchResultObject<Marker[]>): void;
    /**
     ...
     * The watch callback for the labelColor object resolver.
     */
    protected __onResolverForLegendLabelColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    /**
     * Returns the current value of labelColor.
     */
