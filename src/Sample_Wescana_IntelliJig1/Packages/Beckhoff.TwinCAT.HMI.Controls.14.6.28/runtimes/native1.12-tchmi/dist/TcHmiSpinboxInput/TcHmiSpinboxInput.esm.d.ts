import { Controls, ObjectResolver, type Color } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
...
declare class TcHmiSpinboxInput extends TcHmiNumericInput {
     ...
     */
    protected __onResolverForInputBackgroundColorWatchCallback(data: ObjectResolver.IWatchResultObject<Color | null>): void;
    /**
