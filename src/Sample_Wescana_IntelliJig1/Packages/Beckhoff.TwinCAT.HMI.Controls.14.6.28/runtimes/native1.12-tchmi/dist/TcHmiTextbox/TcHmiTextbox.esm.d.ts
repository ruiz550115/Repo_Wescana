import { Controls, type Keyboard, type Locale, ObjectResolver, TcHmiControl, type DestroyFunction, type FontFamily, type FontSizeUnit, type FontStyle, type FontWeight, type FourSidedCss, type HorizontalAlignment, type SolidColor } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
...
declare class TcHmiTextbox extends TcHmiControl.Control {
    ...
    /** Destroyer for the touchend event listener on __elementInput, to clean up on multiline toggle. */
    protected __destroyTouchEndEvent: DestroyFunction | null;
    /**
