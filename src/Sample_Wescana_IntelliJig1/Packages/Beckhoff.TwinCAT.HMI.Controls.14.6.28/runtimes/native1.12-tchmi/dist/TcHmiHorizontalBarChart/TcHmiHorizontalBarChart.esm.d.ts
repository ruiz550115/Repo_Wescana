...
import { HorizontalBarChart } from '../TcHmiCharting/HorizontalBarChart.js';
import { AxisLabeling, AxisPosition, LineStyle, ChartPosition, Orientation } from '../TcHmiCharting/Types.js';
...
declare class TcHmiHorizontalBarChart extends TcHmiControl.Control {
    ...
    protected __barChart: HorizontalBarChart | null;
    ...
    protected __xPosition: keyof typeof ChartPosition | undefined;
     ...
     * Possible Values: Left, Right
     */
    setXPosition(valueNew: keyof typeof ChartPosition | null): void;
    /**
     * Gets the value of xPosition
     * @returns The current value of xPosition
     */
    getXPosition(): "Background" | "Foreground" | undefined;
    /**
     * Processes yPosition
     */
