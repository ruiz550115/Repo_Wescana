import { Controls, EventProvider, ObjectResolver, TcHmiControl, type Color, type ScaleModeString, type SolidColor } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
declare class TcHmiPolygon extends TcHmiControl.Control {
     ...
     */
    protected __onResolverForFillColorWatchCallback(data: ObjectResolver.IWatchResultObject<Color>): void;
    /**
     ...
     */
    protected __onResolverForStrokeColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    /**
