import { Controls, EventProvider, type Locale, ObjectResolver, type Symbol, TcHmiControl, type FontFamily, type FontSizeUnit, type FontStyle, type FontWeight, type FourSidedCss, type HorizontalAlignment, type SolidColor } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
...
declare class TcHmiTimespanInput extends TcHmiControl.Control {
    ...
    /** A minimum for the value in iso 8601 format */
    ...
    protected __isValid(value: string): boolean;
    protected __validateInputForMinValue(value: string, setMinValue?: boolean): boolean;
     ...
     */
    protected __setMinValue(valueNew: string | null): void;
    /**
     ...
     * @param valueNew
     */
    setValueSymbol(valueNew: Symbol<string> | null): void;
    /**
