import { Controls, EventProvider, FilterInstance, Locale, LocalStorage, ObjectPath, ObjectResolver, Server, Symbol, type SymbolExpression, TcHmiControl, type BorderStyle, type Color, type DestroyFunction, type Dictionary, type DimensionUnit, type Filter, type FontFamily, type FontSizeUnit, type FontStyle, type FontWeight, type FourSidedCss, type HierarchicalFilterMap, type HorizontalAlignment, type IErrorDetails, type JsonSchema, type SizeModeWithContent, type SolidColor, type SortingInfo, type VerticalAlignment, type IFunction } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
...
declare class TcHmiTreeView extends TcHmiControl.Control {
    ...
    protected __filterSortMap: HierarchicalFilterMap[] | null;
     ...
     */
    protected __originalIndexToFilterMapElement(index: number[], filterSortMap: HierarchicalFilterMap[]): number[];
    /**
     ...
     */
    protected __filterSortMapIncludesIndex(filterSortMap: HierarchicalFilterMap[], rowIndex: number[], arrayPosition?: number): boolean;
    /**
     ...
     */
    protected __fillFlatDataWithFilterSortMap(data: HierarchicalFilterMap[], flatData: FlatData[]): void;
    /**
     ...
     */
    protected __getHierarchicalSchema(schema: JsonSchema | null | undefined, dataRow: number[] | undefined, columnDefinition: Column | SimpleColumn): string | undefined;
    /**
     ...
     */
    protected __onResolverForColumnsWatchCallback(data: ObjectResolver.IWatchResultObject<Column[] | SimpleColumn>): void;
    /**
     ...
     */
    protected __generateSchemaByDataDefintions(value: any, columnDefinition?: Column | SimpleColumn): JsonSchema;
    /**
     ...
     */
    protected __onResolverForDataWatchCallback(data: ObjectResolver.IWatchResultObject<any[]>): void;
    /**
     ...
     */
    protected __onResolverForDataSchemaWatchCallback(data: ObjectResolver.IWatchResultObject<JsonSchema>): void;
    /**
     ...
     */
    protected __onResolverForSortingWatchCallback(data: ObjectResolver.IWatchResultObject<TcHmiDatagrid.SortingInfo[]>): void;
    /**
     ...
     * The watch callback for the rowNumbersBackgroundColor object resolver
     */
    protected __onResolverForSelectedRowIndexWatchCallback(data: ObjectResolver.IWatchResultObject<number[]>): void;
    /**
