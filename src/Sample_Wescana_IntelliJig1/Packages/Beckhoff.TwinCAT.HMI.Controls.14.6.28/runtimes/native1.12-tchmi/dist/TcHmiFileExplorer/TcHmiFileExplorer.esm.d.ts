import { Controls, FileUploader, type Locale, LocalStorage, ObjectResolver, Server, TcHmiControl, type Localizable, type SortingInfo } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
...
declare class TcHmiFileExplorer extends TcHmiControl.Control {
    ...
    protected __errorPrompt: TextAndButtonsPrompt<undefined> | null;
     ...
     */
    protected __onResolverForSortingWatchCallback(data: ObjectResolver.IWatchResultObject<FileSortingInfo[]>): void;
    /**
     ...
     */
    protected __getListFilesHandler(path: Path): (data: Server.IResultObject<unknown, ServerFileList>) => void;
    /**
...
export interface FileSortingInfo extends SortingInfo {
