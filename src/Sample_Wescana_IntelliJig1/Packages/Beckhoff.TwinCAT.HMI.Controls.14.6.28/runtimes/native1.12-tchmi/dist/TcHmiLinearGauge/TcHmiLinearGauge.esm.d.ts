import { Animation, Controls, type Locale, ObjectResolver, TcHmiControl, type Color, type DimensionUnit, type FontFamily, type FontSizeUnit, type FontStyle, type FontWeight, type FourSidedCss, type SolidColor, type IFunction } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
import { InputProcessingPoint, ValueBuffer } from '../Helpers/TcHmiValueBuffer/ValueBuffer.js';
declare class TcHmiLinearGauge extends TcHmiControl.Control {
    ...
    protected __padding: FourSidedCss | null | undefined;
    ...
    protected __tickColor: Color | null | undefined;
    /** Internal reference to the attribute 'data-tchmi-filler-color' */
    protected __progressBackgroundColor: Color | null | undefined;
    /** Internal reference to the attribute 'data-tchmi-filler-color' */
    protected __progressForegroundColor: Color | null | undefined;
     ...
     */
    protected __onResolverForPaddingWatchCallback(data: ObjectResolver.IWatchResultObject<FourSidedCss>): void;
    /**
     ...
     */
    protected __onResolverForTickColorWatchCallback(data: ObjectResolver.IWatchResultObject<Color>): void;
    /**
     ...
     */
    protected __onResolverForProgressBackgroundColorWatchCallback(data: ObjectResolver.IWatchResultObject<Color>): void;
    /**
     ...
     */
    protected __onResolverForProgressForegroundColorWatchCallback(data: ObjectResolver.IWatchResultObject<Color>): void;
    /**
