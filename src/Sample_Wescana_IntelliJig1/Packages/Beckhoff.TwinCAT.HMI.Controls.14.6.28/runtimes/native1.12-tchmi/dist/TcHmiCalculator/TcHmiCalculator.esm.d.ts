import { Controls, type Locale, type DestroyFunction, TcHmiControl } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
declare global {
    namespace math {
...
declare class TcHmiCalculator extends TcHmiControl.Control {
    #private;
    ...
    protected __destroyLayoutKeysDomEvents: DestroyFunction[];
    /** Reference to the menu keys dom events destroy functions. */
    protected __destroyMenuKeysDomEvents: DestroyFunction[];
    /** Reference to the history elements dom events destroy functions. */
    protected __destroyHistoryElementsDomEvents: DestroyFunction[];
