...
import { LineChart } from '../TcHmiCharting/LineChart.js';
import type { ReferenceLine as ReferenceLineCharting } from '../TcHmiCharting/ReferenceLine.js';
import type { LineGraph } from '../TcHmiCharting/LineGraph.js';
...
declare class TcHmiLineChart extends TcHmiControl.Control {
    ...
    /** Linechart element' */
    protected __lineChart: LineChart | null;
    /** member variables */
    ...
    /**
     * Sets the mirrorXAxis attribute.
     ...
     */
    protected __onResolverForLineGraphDataWatchCallback(data: ObjectResolver.IWatchResultObject<Point[][] | number[][] | number[]>): void;
    /**
