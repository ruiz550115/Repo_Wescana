...
export declare abstract class Popup<T> {
    ...
    protected __justAbove: TopMostLayer.IOptionsEx['justAbove'];
    ...
    protected __storageSettings: UiProvider.PopupProvider.StorageSettings | undefined;
    private __resizeObserver;
    /**
     * Creates a new Popup instance.
     * @param __parentControl The control which owns the popup.
     */
    constructor(__parentControl?: (TcHmiControl.Control | null) | undefined);
    /**
     ...
     */
    protected __applyTextToControl(name: string, text: Localizable | null | undefined, control: TcHmiControl.Control, property: string): void;
    /**
...
export declare class FilterPrompt extends Popup<Filter> {
    protected __okButton: TcHmiButton;
    protected __cancelButton: TcHmiButton;
    ...
    protected __filter: Filter;
    protected __currentFilter: Filter;
    protected __originalFilter: Filter;
    ...
    protected __localization: Locale.PackageLocalization;
     ...
     * @param parentControl The control which owns the popup.
     */
    constructor(schema: JsonSchema | null, originalFilter: Filter, parentControl?: TcHmiControl.Control | null);
    /**
     * Destroys the popup and all its controls.
     * @param force If true, child controls will be removed from the parent control before destruction, to ensure destruction in case of keepAlive === true.
     */
     ...
     */
    update(filter: Filter, _resetable: boolean): void;
    /**
     ...
     */
    protected __createRow(indentation: FilterPrompt.GroupingLevel[], parent: FilterPrompt.FilterNesting, comparison: Comparison, logic?: LogicOperator): HTMLTableRowElement;
    /**
...
export declare namespace FilterPrompt {
    ...
    interface RowData {
        ...
        logic?: {
            control: TcHmiCombobox<LogicOperator['logic']>;
            destroyer: DestroyFunction;
        };
        path: {
